...
describe('DAO', () => {
  ...
  describe('Proposal creation', () => {
    ...
    describe('Success', () => {
      ...
      it('updates propsal count', async () => {
    ...
    describe('Failure', () => {
      it('rejects invalid amount', async () => {
        await expect(dao.connect(investor1).createProposal('Propsal 1', ether(1000), recipient.address)).to.be.reverted
      })

      it('rejects non-investor', async () => {
        await expect(dao.connect(user).createProposal('Propsal 1', ether(1000), recipient.address)).to.be.reverted
      })
    })
